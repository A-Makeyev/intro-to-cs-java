/*
 **********************************************************************************************
 * A program that converts petrol consumption measured in miles per gallon to litres per 100km
 **********************************************************************************************
 */
...
public class Petrol {
    public static void main(String[] args) {
        ...
        final double MAX = 100, MILE_TO_KM = 1.609, LITRES_PER_GALLON = 3.785;
        ...
        double litresTo100km = MAX / ((milesPerGallon * MILE_TO_KM) / LITRES_PER_GALLON);
