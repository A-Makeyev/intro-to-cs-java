...
public class Main {
    public static void main(String []args) {
        ...
        System.out.println("Added train 1: " + rs1.addTrain(f1));
        System.out.println("Added train 2: " + rs1.addTrain(f2));
        System.out.println("\n" + rs1);

        //RemoveTrain
        System.out.println("Removed train 1: " + rs1.removeTrain(f1));
        System.out.println("\n" + rs1);

        //First Train to Destination
        Train f3c = new Train("Tel-Aviv", 11, 35, 180, 100, 200, 35);
        System.out.println("Added train 3: " + rs1.addTrain(f3c));
        Train f3x = new Train("Tel-Aviv", 7, 15, 180, 200, 200, 35);
        System.out.println("Added train 3a: " + rs1.addTrain(f3x));

        System.out.println("\n" + rs1);
        Time1 t1z = rs1.firstDepartureToDestination("Tel-Aviv");
        System.out.println("The first train to Tel-Aviv departs at " + t1z);

        //HowMany Full Trains
        int y = rs1.howManyFullTrains();
        System.out.println("Full Trains - " + y);

        //Most Popular Destination
        String mostPopularDestination = rs1.mostPopularDestination();
        System.out.println("Most Popular Destination - " + mostPopularDestination);

        //Most Expensive Ticket
        Train mostExpensiveTicket = rs1.mostExpensiveTicket();
        System.out.println("Most Expensive Ticket - " + mostExpensiveTicket);

        //Longest Train
        Train theLongestTrain = rs1.longestTrain();
        System.out.println("Longest Train - " + theLongestTrain);


         /***************************** RailwayStation Round 2 ************************************/
        /*******************************************************************************************/
